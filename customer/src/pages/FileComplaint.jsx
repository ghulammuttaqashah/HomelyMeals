      ...
      <main className="flex-grow container mx-auto px-4 py-6 max-w-5xl">
        ...
        <div className="mb-6">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mt-0.5">
              Let us know what went wrong and our admin team will investigate.
            </p>
          </div>
        </div>
        ...
        {(() => {
          const filteredOrders = orders.filter((order) => {
            ...
            const cookName = (order.cook?.name || "").toLowerCase();
            return orderNum.includes(term) || items.includes(term) || cookName.includes(term);
          });
                        ...
                        <div className="absolute z-20 top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden flex flex-col">
                          <div className="p-3 border-b border-gray-100 bg-gray-50">
                            <div className="relative">
                              ...
                              <input
                                type="text"
                                placeholder="Search ID, Cook, Items..."
                                value={searchQuery}
