...
const StarRating = ({ rating = 0, onChange, size = 'md', interactive = false, showCount = false, count = 0 }) => {
    const sizes = {
        sm: 'w-3 h-3',
        md: 'w-5 h-5',
        lg: 'w-6 h-6',
            ...
            if (interactive) {
                ...
                stars.push(
                    <button
                        ...
                        className={`${sizeClass} transition-colors ${i <= rating ? 'text-orange-500' : 'text-gray-300 hover:text-orange-400'
                            }`}
                    >
