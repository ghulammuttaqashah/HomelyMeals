            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8">
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-sm text-gray-500 mt-2">Reviews need to be submitted first.</p>
                    </div>
                </div>
            </div>
        )
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full my-8 max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200 sticky top-0 bg-white z-10 rounded-t-2xl">
                    <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                            {analytics.totalReviews} {analytics.totalReviews === 1 ? 'order' : 'orders'} • {analytics.averageRating.toFixed(1)} ⭐ average rating
                        </p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-8 pb-6">
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-8">
                        <div 
                            className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border-2 border-green-200 shadow-sm cursor-pointer hover:shadow-md transition-shadow"
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-green-600 mt-1">Click to explore</p>
                                </div>
                        ...
                        <div 
                            className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border-2 border-red-200 shadow-sm cursor-pointer hover:shadow-md transition-shadow"
                            onClick={() => setSelectedSentiment('Negative')}
                        >
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm font-medium text-red-700 mb-1">Negative Aspects</p>
                                    <p className="text-4xl font-bold text-red-600">{totalNegative}</p>
                                    <p className="text-xs text-red-600 mt-1">Click to explore</p>
                                </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                        ...
                        <ResponsiveContainer width="100%" height={350}>
                            ...
                            >
                                ...
                                <YAxis 
                                    ...
                                    axisLine={{ stroke: '#e5e7eb' }}
                                    label={{ value: 'Aspect Mentions', angle: -90, position: 'insideLeft', style: { fill: '#6b7280', fontSize: 12 } }}
                                />
                        ...
                        <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                            <p className="text-sm text-blue-800 flex items-start gap-2">
                                ...
                                <span>
                                    <span className="font-semibold">Click on any bar or card</span> to see detailed aspect breakdown for that sentiment
                                </span>
                            </p>
                        </div>
                    </div>
