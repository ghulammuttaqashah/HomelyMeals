...
const COMPLAINT_TYPES = [
  {
    value: "False Claim by Customer",
    label: "False Claim by Customer",
    description: "A customer made a false complaint or claim about your food or service.",
    icon: "🚫",
  },
  {
    value: "Customer Misuse",
    label: "Customer Misuse",
    description: "A customer abused the service, made unreasonable demands, or was disrespectful.",
    icon: "⚠️",
  },
  {
    value: "Payment Issue",
    label: "Payment Issue",
    description: "You didn't receive payment, were underpaid, or experienced a payment dispute.",
    icon: "💳",
  },
];
      ...
      <main className="flex-grow container mx-auto px-4 py-6 max-w-2xl">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">
            Report an issue with a customer and our team will investigate.
          </p>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-5 border border-gray-100">
              ...
              >
                ...
                {orders.map((order) => {
                  ...
                  const customerName = order.customer?.name ? ` (for ${order.customer.name})` : "";
                  
                  return (
                    <option key={order._id} value={order._id}>
                      {dateStr} — {itemsStr}{customerName} — Rs. {order.totalAmount}
                    </option>
                  );
                })}
              </select>
            ...
            <div className="bg-white rounded-xl shadow-sm p-5 border border-gray-100 space-y-5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mb-2">
                  Include specifics like what happened, the customer's behavior, and relevant order details.
                </p>
                <textarea
                  value={description}
                  ...
                  rows={4}
                  maxLength={1000}
                  placeholder="E.g., The customer claimed the food was not delivered, but I have proof of delivery via photo..."
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mb-3">
                  Optional — screenshots or photos strengthen your case (max 5, JPG/PNG under 5MB)
                </p>
