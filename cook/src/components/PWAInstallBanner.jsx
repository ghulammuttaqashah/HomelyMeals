      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 relative">
        ...
        <div className="mb-6 px-2">
          <div className="flex items-start gap-3 text-sm text-gray-700 bg-green-50 rounded-lg p-3 border border-green-100">
            ...
            <span className="leading-relaxed">Get a native mobile app experience with quick access from your home screen, instant notifications, and full offline functionality</span>
          </div>
        </div>
