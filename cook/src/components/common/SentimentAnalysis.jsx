...
function SentimentAnalysis({ user, onBack }) {
  ...
  useEffect(() => {
    const mockReviews = [
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Great taste, though I wish there were more peanuts. Overall very satisfied!",
        sentiment: "positive",
        date: "2024-11-14",
      },
      {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <h1 className="text-purple-600 text-2xl font-bold">Sentiment Analysis</h1>
              ...
              <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700">
                    {positivePercentage}% of recent reviews are positive. Customers
                    particularly love the authenticity and flavor of your meals.
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-yellow-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700">
                      Some customers mentioned portion sizes and delivery
                      temperature. Consider reviewing these aspects to improve
                      satisfaction.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    Tacos al Pastor and Margherita Pizza are your highest-rated
                    dishes with consistent 5-star reviews.
                  </p>
                </div>
              </div>
            </div>
