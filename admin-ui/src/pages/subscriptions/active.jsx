            ...
            <div className="overflow-x-auto">
              <table className="w-full divide-y divide-gray-200 text-sm" style={{minWidth: '600px'}}>
                <thead className="bg-gray-50 text-left text-xs uppercase text-gray-500">
                  <tr>
                    <th className="px-2 sm:px-3 py-2">Cook ID</th>
                    ...
                    <th className="px-2 sm:px-3 py-2">Start Date</th>
                    <th className="px-2 sm:px-3 py-2">End Date</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {subscriptions.map((item) => (
                    <tr key={item._id}>
                      <td className="px-2 sm:px-3 py-2 text-xs text-gray-700">{item.cook?._id || '-'}</td>
                      ...
                      <td className="px-2 sm:px-3 py-2">{item.start_date ? new Date(item.start_date).toLocaleDateString() : '-'}</td>
                      <td className="px-2 sm:px-3 py-2">{item.end_date ? new Date(item.end_date).toLocaleDateString() : '-'}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
